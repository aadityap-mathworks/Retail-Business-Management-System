...
<title>Return Purchase|Gheun Tak</title>
...
<div class="page">
  ...
  <div class="middle">
  	<br>
 	<center><h1><font size="23" color="#268f9b">RETURN PURCHASE</font></h1></center>
 	<br>
 	<font color="red" size="5"><%
    String error= (String) session.getAttribute("No Puchase to return");
    ...
    %></font>
 	...
 	<form action="ReturnPurchaseServlet" method="post">
	<table id="customers" >
  	<thead>
            <tr>
                <th>PUR#</th>
          ...
          //exection 
            ...
            while(rs.next()){
                ...
                <tr>
                    ...
                    %>
                    <!-- table entries -->
                    <td><input type="radio" name="pur2#" value="<%=PUR %>"required="required"> <%=PUR %></td>
                   <td><%=EID %></td>
                   <td><%=PID%></td>
                   <td><%=CID %>
                   <td><%=QTY %></td>
                ...
                %>
    		<tr>
            <td colspan="7" rowspan="2"><button type="submit" name="Get puchase savings" style="size:20;">Return Purchase</button>
            </td>
            </tr>
            </tbody>
        </table>
